          ...
          <div className="mb-6">
            {isEditing ? (
              <input
                ...
                onChange={(e) => handleFieldChange('header', 'name', e.target.value)}
            ...
            {isEditing ? (
              <input
                ...
                onChange={(e) => handleFieldChange('header', 'role', e.target.value)}
              ...
              {['phone', 'email', 'linkedin', 'location'].map((field) =>
                isEditing ? (
                  <input
                    ...
                    onChange={(e) => handleFieldChange('header', field, e.target.value)}
          ...
          <div className="mb-6">
            ...
            {isEditing ? (
              <textarea
                ...
                onChange={(e) => setLocalData((prev) => ({ ...prev, summary: e.target.value }))}
                ...
                <div key={index} className="flex items-center gap-2">
                  {isEditing ? (
                    <>
                      ...
                      />
                      <button className="text-red-600" onClick={() => handleDeleteItem('skills', index)}>
                        ✕
                      </button>
                    </>
                  ) : (
                    <span className="bg-gray-200 px-2 py-1 rounded text-sm">{skill}</span>
                  )}
                </div>
              ))}
            </div>
